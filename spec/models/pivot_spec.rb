...
RSpec.describe Pivot, type: :model do
    ...
    #tests go here
    subject { Pivot.new(user_id: 3, club_name: 'Club pato cornejo', sport_name: 'Tenis', date_time: '2022-09-30 10:36:01', moderador_id: 2, club_address: 'Raul Labbe', status: 'pending')}
